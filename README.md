...
Visit [SQL Try Editor at W3Schools.com](https://www.w3schools.com/Sql/trysql.asp?filename=trysql_select_all) using the **Google Chromb e (or Chromium if you use Linux) browser** and write _SQL queries_ for the following requirements:
